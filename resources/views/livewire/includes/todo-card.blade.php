<div wire:key="{{$todo->id}}" class="todo mb-5 card px-5 py-6 bg-white col-span-1 border-t-2 border-blue-500 hover:shadow">
    <div class="flex justify-between space-x-2">
        ...
        <div class="flex items-center space-x-2">
            <input type="checkbox" class="form-checkbox h-5 w-5 text-teal-600" wire:click="toggleTodoStatus({{ $todo->id }})"
            ...
            @else
                <input type="text" wire:model.defer="newName" placeholder="Todo Name.."
